...
<script src="<?=ADMIN_PAGES_SCRIPTS?>maintenanceInput.js<?=VERSION?>" type="text/javascript"></script>
...
jQuery(document).ready(function() {    
	...
	// page functions
	maintenanceInput.init();
	<?php if ($subsection == 'maintenanceInput'): ?>
	maintenanceInput.manageInput();
	<?php endif; ?>
	<?php if ($subsection == 'preinvoiceInput'): ?>
	maintenanceInput.preinvoiceInput();
	<?php endif; ?>
});
</script>