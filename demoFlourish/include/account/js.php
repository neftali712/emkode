...
<script src="<?=ADMIN_PAGES_SCRIPTS?>account.js<?=VERSION?>" type="text/javascript"></script>
...
jQuery(document).ready(function() {    
	...
	// page functions
	Account.init();
	<?php if ($subsection == 'manageAccount'): ?>
	Account.manageAccount();
	<?php elseif ($subsection == 'expenseInvoice'): ?>
	Account.expenseInvoice();
	<?php elseif ($subsection == 'expenseSalesReceipt'): ?>
	Account.expenseSalesReceipt();
	<?php elseif ($subsection == 'transaction'): ?>
	Account.transaction();
	<?php endif; ?>
});
</script>