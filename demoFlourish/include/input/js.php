...
<script src="<?=ADMIN_PAGES_SCRIPTS?>input.js<?=VERSION?>" type="text/javascript"></script>
...
jQuery(document).ready(function() {    
	...
	// page functions
	Input.init();
	<?php if ($subsection == 'manageInput'): ?>
	Input.manageInput();
	<?php elseif ($subsection == 'warehouse'): ?>
	Input.warehouse();
	<?php elseif ($subsection == 'purchaseInput'): ?>
	Input.purchaseRequisition();
	Input.purchaseOrder();
	<?php endif; ?>
});
</script>