...
<?php if ($subsection == 'creditorInvoice'): ?>
...
<script src="<?=ADMIN_PAGES_SCRIPTS?>creditor.js<?=VERSION?>" type="text/javascript"></script>
...
jQuery(document).ready(function() {    
	...
	// page functions
	Creditor.init();
	<?php if ($subsection == 'manageCreditor'): ?>
	Creditor.manageCreditor();
	<?php elseif ($subsection == 'creditorInvoice'): ?>
