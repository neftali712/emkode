...
<script src="<?=ADMIN_PAGES_SCRIPTS?>catalogAccount.js<?=VERSION?>" type="text/javascript"></script>
...
jQuery(document).ready(function() {
	...
	// page functions
	CatalogAccount.init();
	<?php if ($subsection == 'manageCatalogAccount'): ?>
	CatalogAccount.manageCatalogAccount();
	<?php endif; ?>
});
</script>
